...
func (_BalanceTracker *BalanceTrackerCaller) MAXSYSTEMADDRESSCOUNT(opts *bind.CallOpts) (*big.Int, error) {
	...
	if err != nil {
		return new(big.Int).Set(out0), err
	}
