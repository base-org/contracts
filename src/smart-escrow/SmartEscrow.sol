...
contract SmartEscrow is AccessControl {
    ...
    constructor(
        ...
        require(beneficiaryAddress != address(0), "SmartEscrow: beneficiaryAddress is zero address");
        ...
        require(endTimestamp > startTimestamp, "SmartEscrow: end time is before start time");
    ...
    function updateBeneficiary(address newBeneficiary) external virtual onlyRole(BENEFICIARY_OWNER) {
        ...
        if (_beneficiary != newBeneficiary) {
    ...
    /**
     * @dev Amount of OP already released
     */
